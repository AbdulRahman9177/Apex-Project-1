...
,p_group_id=>wwv_flow_imp.id(73308331734693720397)
,p_javascript_code_onload=>'apex.pwa.initPushSubscriptionPage();'
,p_step_template=>1661186590416509825
,p_page_template_options=>'#DEFAULT#:js-dialog-class-t-Drawer--pullOutEnd'
,p_required_patch=>wwv_flow_imp.id(73308331917860720397)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73308333263198720399)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73308333603385720399)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(73308332978159720398)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(73308334168027720400)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(73308333603385720399)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(73308334417594720400)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(73308334980146720400)
,p_event_id=>wwv_flow_imp.id(73308334417594720400)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(73308335462426720401)
,p_event_id=>wwv_flow_imp.id(73308334417594720400)
